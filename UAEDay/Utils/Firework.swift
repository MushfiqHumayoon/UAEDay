...
class Firework {
    init() {}
    func startEmitter(size: CGSize) -> UIView {
        ...
        particlesLayer.emitterPosition = CGPoint(x: 237.2, y: 615.4)
        ...
        let image1_1 = UIColor.orange.image(CGSize(width: 30, height: 30)).cgImage
        ...
        let image1_2 = UIColor.cyan.image(CGSize(width: 10, height: 10)).cgImage
